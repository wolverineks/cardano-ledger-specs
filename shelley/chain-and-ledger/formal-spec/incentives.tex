...
\hypersetup{
  ...
  \begin{changelog}
        ...
        \change{2019/11/26}{Kevin Hammond}{FM (\IOHK)}{Version 0.5.  Removed number of pools parameter for testnet to ensure consistency with release version.  Altered summary of differences
          between testnet and mainnet and added description of the Edinburgh workshop, as requested.  First public version of document.}
      \end{changelog}
      \clearpage%
\begin{landscape}
\floatstyle{plain}
...
using an instantaneous rewards return mechanism that will not incur any transaction fees.
\khcomment{JC/MG to expand.}
\khcomment{TODO: Verify that the Testnet rewards will not be added to stake pots.
  Still not clear from the Testnet documentation, and they are less than two weeks from release.}
